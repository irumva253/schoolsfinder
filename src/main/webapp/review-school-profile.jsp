...
<head>
    ...
    <!--====== Title ======-->
    <title>Schools Finder - Aid</title>
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a class="active" href="secondary-courses.jsp">Secondary</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Secondary</a></li>
                  ...
                  <div class="blog-details mt-30">
                      ...
                      <div class="cont">
                          ...
                          <ul>
                           ...
                           <br>
                           <h5 class="active"><a href="#"><i class="fa fa-download"></i> Click here to download school transcript (Babyeyi)</a></h5>
                           <ul class="share">
                           ...
                           <div class="col-lg-12 col-md-6">
                               ...
                               <div class="categories mt-30">
                                   ...
                                   <ul>
                                       ...
                                       <li><a href="#">Study Requirement</a></li>
