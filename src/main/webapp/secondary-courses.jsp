                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li><a href="primary-schools.html">Primary</a></li>
                                            <li><a href="secondary-schools.html">Secondary</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="active" href="courses.html">Courses</a>
                                        <ul class="sub-menu">
                                            <li><a href="primary-courses.html">Primary</a></li>
                                            <li><a href="secondary-courses.html">Secondary</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-3 col-4">
                        <div class="right-icon text-right">
                            <ul>
                                ...
                                <li><a href="auth-login.html"><i class="fa fa-user"></i></a></li>
                            </ul>
                        </div> <!-- right icon -->
                    </div>
                </div> <!-- row -->
