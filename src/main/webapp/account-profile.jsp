...
<html lang="en">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
        ...
        <title>Account Settings - Profile - Schools Finder</title>
                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <nav class="nav nav-borders">
                            <a class="nav-link active ms-0" href="account-profile.jsp">Profile</a>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <!-- Form Group (username)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputUsername">User ID (how your ID will appear to other users on the site)</label>
                                                <input class="form-control" id="inputUsername" type="text" placeholder="${user.user_id}" disabled/>
                                            </div>
                                            <!-- Form Row-->
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="${user.fname}" disabled />
                                                </div>
                                                <!-- Form Group (last name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputLastName">Last name</label>
                                                    <input class="form-control" id="inputLastName" type="text" placeholder="${user.lname}" disabled />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputPhone" type="tel" placeholder="${user.phone}" disabled />
                                                </div>
                                                <!-- Form Group (birthday)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputStatus">Role</label>
                                                    <input class="form-control" id="inputBirthday" type="text" name="role" placeholder="${user.role}" disabled />
                                                </div>
                                            </div>
