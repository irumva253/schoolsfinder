...
<body>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            ...
                            <div class="button float-left"> 
                                <a href="#" class="main-btn">Profile your school for free</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shop-top-search">
                        ...
                        <!--    <select>
                                <option value="1">Sort by location</option>
                        ...
                        <a href="#" class="main-btn" data-toggle="modal" data-target="#findschoolModal">Find School of your choice</a>                     
                    </div> <!-- shop top search -->
                </div>
    ...
    <!-- Find School of your choice Modal-->
  <div class="modal fade" id="findschoolModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Find School of your choice</h5>
...
<!-- END Find School of your choice Modal-->
