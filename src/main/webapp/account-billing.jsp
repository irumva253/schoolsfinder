                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <div class="card card-header-actions mb-4">
                            <div class="card-header">
                                Payment Methods
                                <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Add Payment Method</button>
                            </div>
                            <!-- Modal -->
							<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
							    <div class="modal-dialog modal-dialog-centered" role="document">
							        <div class="modal-content">
							            ...
							            <form action="AddPaymentMethod" method="post" enctype="multipart/form-data">
							            <div class="modal-body">    
							            <!-- Form Row-->
                                            <div class="row gx-3 mb-3">
                                                <!-- Form Group (Card name)-->
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputCardName">Card name</label>
                                                    <input class="form-control" id="inputCardName" type="text" placeholder="Enter card name" name="card_name" required/>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputCardComment">Card Comment</label>
                                                    <input class="form-control" id="inputCardComment" type="text" placeholder="Comment here..."  name="card_comment" required />
                                                </div>
                                            </div>
                                            <!-- Form Row        -->
                                            <!-- Form Group (email address)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputCardLogo">Card Logo</label>
                                                <input class="form-control" id="inputCardLogo" type="file" name="card_logo" />
                                            </div>
                                            <!-- Form Row-->
							            </div>
							            <div class="modal-footer"><button class="btn btn-danger btn-sm" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary btn-sm" type="submit">Save changes</button>
							           </div></form>						           
							        </div>
							    </div>
							</div>
