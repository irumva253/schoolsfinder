                    ...
                    <div class="container-xl px-4 mt-5">
                        ...
                        <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                            <div class="me-4 mb-3 mb-sm-0">
                                ...
                                <div class="small" id="demo">
                                    <span class="fw-500 text-primary"> ToDay</span> 
                                  <!--  <script>const weekday = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
                                    const a = new Date();
                                    let day = weekday[a.getUTCDay()];
                                    document.getElementById("demo").innerHTML = day;</script> --> 
                                <div id="demo2"> 
                                  <script>
	                               const d = new Date();
	                               document.getElementById("demo2").innerHTML = d;</script>
	                               </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-waves mb-4 mt-5">
                            <div class="card-body p-5">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col">
                                        <h2 class="text-primary">Welcome back <b>${user.fname}</b>, your dashboard is ready!</h2>
                                        <p class="text-gray-700">Hello once again, we are thanking you for joining our community, please if it is your first time here click on button bellow to register your school.</p>
                                        <a class="btn btn-primary p-3" href="admin-profile-school.jsp">
                                            PROFILE YOUR SCHOOL
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card bg-primary border-0">
                                    <div class="card-body">
                                        <h5 class="text-white-50">Budget Overview /Billing</h5>
                                        <div class="mb-4">
                                            <span class="display-4 text-white">RWF 48k</span>
