                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul>
                                ...
                                <li><a href="shop.html"><i class="fa fa-angle-right"></i>Schools</a></li>
                                <li><a href="teachers.html"><i class="fa fa-angle-right"></i>Head Teachers</a></li>
