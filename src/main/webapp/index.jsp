...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="images/all-icon/call.png" alt="icon"><span>(251) 788 000 000</span></li>
                                <li><img src="images/all-icon/email.png" alt="icon"><span>info@schoolsfinder.com</span></li>
                                <li><img src="images/all-icon/map.png" alt="icon"><span>KN/5 Kigali, Rwanda</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            <div class="support float-left">
                                ...
                                <div class="cont">
                                    <p>Need Help? call us 24h/7</p>
                                    <span>+250 780 000 000</span>
                                </div>
                            </div>
                            <div class="button float-left"> 
                                <a href="auth-signup.jsp" class="main-btn">Profile your school for free</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- row -->
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="#">Schools</a>
                                        <ul class="sub-menu">
                                            <li><a href="primary-schools.jsp">Primary</a></li>
                                            <li><a href="secondary-schools.jsp">Secondary</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#">Courses</a>
                                        <ul class="sub-menu">
                                            <li><a href="primary-courses.jsp">Primary</a></li>
                                            <li><a href="secondary-courses.jsp">Secondary</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-3 col-4">
                        <div class="right-icon text-right">
                            <ul>
                                ...
                                <li><a href="auth-login.jsp"><i class="fa fa-user"></i></a></li>
                            </ul>
                        </div> <!-- right icon -->
                    </div>
                </div> <!-- row -->
    ...
    <div class="search-box">
        <div class="serach-form">
            ...
            <form action="#">
                <input type="text" placeholder="Quick Search: School Name or Location">
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s">Find the ideal school for your child.</h1>
                            <p data-animation="fadeInUp" data-delay="1.3s">Select educational level below: </p>
                            <ul>
                                <li><a data-animation="fadeInUp" data-delay="1.6s" class="main-btn" href="#">Primary Schools <i>& Pre-Schools</i></a></li>
                                <li><a data-animation="fadeInUp" data-delay="1.9s" class="main-btn main-btn-2" href="#">Secondary Schools <i>& Sixth-Form</i></a></li>
                            </ul>
                        </div>
                    </div>
                </div> <!-- row -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="category-text pt-40">
                            <h2>Best platform to enroll School</h2>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mt-50">
                        <h5>About us</h5>
                        <h2>Welcome to Schools Finder</h2>
                    </div> <!-- section title -->
            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-6 col-md-4 col-sm-5">
                    <div class="products-btn text-right pb-60">
                        <a href="#" class="main-btn">All Schools</a>
                    </div> <!-- products btn -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row patnar-slied">
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="images/patnar-logo/mineduc.jpg" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="images/patnar-logo/REB.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="images/patnar-logo/nesa.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="images/patnar-logo/RTB.jpg" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="images/patnar-logo/RP.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="images/patnar-logo/UR.png" alt="Logo">
                    </div>
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
